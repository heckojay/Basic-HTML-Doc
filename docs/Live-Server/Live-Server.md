...
Assuming you are still in Vscode, you will look through the extension marketplace to discover useful tools that will save you time, [debug] code faster, earn immediate feedback, allowing you to learn efficiently.

1. **Click** the [Extensions] :material-crop-square: icon.

      ![VSCode](images/stp1LS.png)

2. **Enter** "Live Server" and **click** install on the extension with the author: "Ritwick Dey".

      ![VSCode](images/stp2LS.png)
    ...
    ??? tip "Are There Any Other Extensions Worth Getting?"
        ...
        <br>- "vscode-pdf" by "tomoki1207". For displaying PDFs in Vscode.
